...
<head>
	...
	<link href="../Assets/styles/pizza.css" rel="stylesheet" type="text/css">
...
<body>
	...
	<div class="wrapper">
		<div class="items">
			<div class="title">
				<h1 id="classic">~ Italiana ~</h1>
			</div>
			<div class="container">
				<div class="colum">
					<div class="imgcontainer">
						<img id="tc1" src="../Assets/images/pizza/tc1.jpg">
						<div class="overlay">
					...
					<form class="form" method="post" action="../Controller/../Controller/itemadding_server.php?action=add&id=tc1">
						...
						<ul class="radio">
							<li><input type="radio" id="tc1S" name="price_size" value="890,Personal" checked>
								<label for="tc1S">Personal</label>
							</li>
							<li><input type="radio" id="tc1M" name="price_size" value="1370,Medium">
								<label for="tc1M">Mediana</label>
							</li>
							<li><input type="radio" id="tc1L" name="price_size" value="1900,Large">
								<label for="tc1L">Familiar</label>
							</li>
						</ul>
						<input type="number" class="quantity" name="quantity" value="1" min="1" max="10">
						<button type="submit" name="add" class="btn" value="pizza">Añadir al carrito<i class="fas fa-shopping-cart"></i></button>
					</form>
				</div>

				<div class="colum">
					<div class="imgcontainer">
						<img id="tc2" src="../Assets/images/pizza/tc2.jpg">
						<div class="overlay">
				...
				<div class="colum">
					<div class="imgcontainer">
						<img id="tc3" src="../Assets/images/pizza/tc3.jpg">
						<div class="overlay">
				...
				<div class="colum">
					<div class="imgcontainer">
						<img id="tc4" src="../Assets/images/pizza/tc4.jpg">
						<div class="overlay">
				...
				<div class="colum">
					<div class="imgcontainer">
						<img id="tc5" src="../Assets/images/pizza/tc5.jpg">
						<div class="overlay">
				...
				<div class="colum">
					<div class="imgcontainer">
						<img id="tc6" src="../Assets/images/pizza/tc6.jpg">
						<div class="overlay">
				...
				<div class="colum">
					<div class="imgcontainer">
						<img id="tc7" src="../Assets/images/pizza/tc7.jpg">
						<div class="overlay">
				...
				<div class="colum">
					<div class="imgcontainer">
						<img id="tc8" src="../Assets/images/pizza/tc8.jpg">
						<div class="overlay">
				...
				<div class="colum">
					<div class="imgcontainer">
						<img id="tc9" src="../Assets/images/pizza/tc9.jpg">
						<div class="overlay">
				...
				<div class="colum">
					<div class="imgcontainer">
						<img id="tc91" src="../Assets/images/pizza/tc91.jpg">
						<div class="overlay">
				...
				<div class="colum">
					<div class="imgcontainer">
						<img id="tc92" src="../Assets/images/pizza/tc92.jpg">
						<div class="overlay">
				...
				<div class="colum">
					<div class="imgcontainer">
						<img id="tc93" src="../Assets/images/pizza/tc93.jpg">
						<div class="overlay">
				...
				<div class="colum">
					<div class="imgcontainer">
						<img id="tc94" src="../Assets/images/pizza/tc94.jpg">
						<div class="overlay">
